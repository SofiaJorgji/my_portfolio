...
function Boss() {
	...
	this.fire = function() {
		...
		this.bulletPool.get(this.x + this.width / 2, this.y + this.height, this.bulletspeed);
	};
}
...
// 		}
	...
	this.fire = function() {
		this.bulletspeed= -2.5 - 0.25*(game.level - 1);
		game.enemyBulletPool.get(this.x + this.width / 2, this.y + this.height, this.bulletspeed);
	};
...
window.requestAnimFrame = (function(){
	return  window.requestAnimationFrame       || 
			window.webkitRequestAnimationFrame || // safari or/and chrome
